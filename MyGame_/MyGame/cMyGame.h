...
namespace eae6320
{
	...
	private:
		...
		virtual const char* GetMainWindowClassName() const override { return "Luis' EAE6320 My Main Window Class"; }
		...
		void CheckBoundaries(eae6320::MyGame::cGameObject* object);
		void SpawnAsteroid();
		void SpawnPowerUp();
		void RespondToCollisions(eae6320::CollisionSystem::CollisionPair pair);
		eae6320::MyGame::cGameObject* ReturnProjectile();
		void DestroyGameObject(eae6320::MyGame::cGameObject* object);
		void PlayExplosion();
		void PlayBGMusic();
		void PlayPowerUp();
		void PlayPowerDown();
		...
		void PlayShot();
		void RestartGame();
		eae6320::MyGame::cGameObject* FindObjectCollider(uint16_t i_ID);
