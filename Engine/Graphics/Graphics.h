...
namespace eae6320
{
	...
	namespace Graphics
	{
		...
		void SubmitBackBufferColor(const float m_r, const float m_g, const float m_b, const float m_a);
		void SubmitGameObjectsToRender(eae6320::MyGame::cGameObject* gameobject[]);
		void SubmitCamera(eae6320::Graphics::cCamera* i_camera);
