...
ID3D11RenderTargetView* eae6320::GraphicsAssistant::s_renderTargetView = nullptr;
// A depth/stencil view allows a texture to have depth rendered to it
ID3D11DepthStencilView* eae6320::GraphicsAssistant::s_depthStencilView = nullptr;
#endif

void eae6320::GraphicsAssistant::ClearFrame(float r, float g, float b, float a)
{
#if defined( EAE6320_PLATFORM_D3D )
...
void eae6320::GraphicsAssistant::SwapImages()
{
#if defined( EAE6320_PLATFORM_D3D )
	////////////////////////////////////////////////////////////////////////////////////////////////////////
...
eae6320::cResult eae6320::GraphicsAssistant::InitializeAssetManagers()
{
	auto result = Results::Success;
	// Initialize the asset managers
	{
		if (!(result = eae6320::Graphics::cRenderState::s_manager.Initialize()))
		{
			EAE6320_ASSERTF(false, "Can't initialize Graphics without the render state manager");
			return result;
		}
		if (!(result = eae6320::Graphics::cShader::s_manager.Initialize()))
		{
...
#if defined( EAE6320_PLATFORM_D3D )
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if (!(result = eae6320::Graphics::cVertexFormat::s_manager.Initialize()))
		{
...
eae6320::cResult eae6320::GraphicsAssistant::InitializeViews(const eae6320::Graphics::sInitializationParameters& i_initializationParameters)
{
	auto result = Results::Success;
...
eae6320::cResult eae6320::GraphicsAssistant::CleanUpAssetManagers()
{
	auto result = Results::Success;
	{
		const auto result_shaderManager = eae6320::Graphics::cShader::s_manager.CleanUp();
	...
	{
		const auto result_renderStateManager = eae6320::Graphics::cRenderState::s_manager.CleanUp();
	...
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////
		const auto result_vertexFormatManager = eae6320::Graphics::cVertexFormat::s_manager.CleanUp();
...
void eae6320::GraphicsAssistant::CleanUpViews()
{
#if defined( EAE6320_PLATFORM_D3D )
